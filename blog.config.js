...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yann', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '放弃幻想，准备斗争', // 作者简介
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION ||
    '记录 AI、技术、学习和一些持续成形的想法。',
  LINK:
    process.env.NEXT_PUBLIC_LINK ||
    'https://notion-next-gamma-one-29.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yann, AI, 技术, 博客, Notion', // 网站关键词 英文逗号隔开
